...
- Create a copy of ``github_monitor/settings/local.py.example``:
  `cp github_monitor/settings/local.py.example github_monitor/settings/local.py` (remembering you should replace `github_monitor` with your project's name!).
